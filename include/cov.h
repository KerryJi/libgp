...
public:
  ...
  virtual bool init(int input_dim) { return false; };
  ...
  /** Covariance gradient of two input vectors with respect to the
   * hyperparameters.
   *  @param x1 first input vector
   *  @param x2 second input vector
...
protected:
  ...
  /** Parameter vector containing the log hyperparameters of the covariance
   * function.
